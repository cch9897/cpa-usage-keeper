  ...
  zh: {
    translation: {
      ...
      auth: {
        ...
        console_hint: '管理员可进入完整控制台；API Key 查看者只能查看该凭证对应的只读概览。',
        ...
        api_key_hint: 'API Key 访问只会打开对应凭证的只读用量概览。',
      ...
      key_overview: {
        eyebrow: 'API Key 概览',
        title: 'API Key 用量概览',
        subtitle: '只读查看当前凭证的 CPA 用量分析，包括请求量、Token 构成、成本趋势与稳定性时间线。',
  ...
  'zh-TW': {
    translation: {
      ...
      auth: {
        ...
        console_hint: '管理員可進入完整控制台；API Key 檢視者只能查看該金鑰對應的唯讀總覽。',
        capabilities_label: '用量控制台能力',
        ...
        api_key_hint: 'API Key 存取只會開啟對應金鑰的唯讀用量總覽。',
      ...
      key_overview: {
        eyebrow: 'API Key 總覽',
        title: 'API Key 用量總覽',
        subtitle: '唯讀查看目前金鑰的 CPA 用量分析，包括請求量、Token 組成、成本趨勢與穩定性時間軸。',
