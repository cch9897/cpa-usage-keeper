...
describe('Credential section styles', () => {
  ...
  it('keeps Auth Files inspection separate from the quota refresh pill', () => {
    ...
    expect(cssBlock('.credentialInspectionStatCardLimitReached')).toContain('color: var(--danger-color);')
    ...
    expect(cssBlock('.credentialInspectionStatusLimitReached')).toContain('background: color-mix(in srgb, var(--danger-color) 12%, transparent);')
    expect(cssBlock('.credentialInspectionStatusLimitReached')).toContain('color: var(--danger-color);')
